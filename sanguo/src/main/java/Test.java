...
public class Test {
	...
	public static void main(String[] args) throws Exception {
		...
		// doJx();
		// String responseStr =
		// "dwr.engine._remoteHandleCallback('1','0',{checkId:\"2014-02-26 17:23:19\",desktopType:\"game\",desktopUrl:null,desktopVersion:0,disuseEndTime:null,logOnServers:s0,name:\"1439814\",resultCode:0,serverId:\"8\",sex:1,type:0,userId:1439814});";
		...
		// }
		// Header h = new
		// Header("Set-Cookie","JSESSIONID=7D11F3545ABF62AAB32F53BCA85509F5; Path=/hero/; HttpOnly");
	...
	// public static void doConsume(final CountDownLatch cdl,final int i,final
	// int numberId,final int batchId,int sleepTime) {
	// // TODO Auto-generated method stub
	// // 构造HttpClient的实例
	// HttpClient httpClient = new HttpClient();
	// // 创建GET方法的实例
	...
	public static void msgIdFightBegin(int i) {
		...
		postMethod.addParameter(new NameValuePair("c0-e4", "string:3%2c1663589%261507410%2c1507410"));
		postMethod.addParameter(new NameValuePair("c0-param1", "Object_Object:{instanceId:reference:c0-e1, messageType:reference:c0-e2, messageId:reference:c0-e3, message:reference:c0-e4}"));
	...
	public static void msgIdRoundEnd(int i) {
		...
		postMethod.addParameter(new NameValuePair("c0-e4", "string:180%3b7-2%2c2d-6%3a58%2c63-6%3a58%2c91-6%3a58%3b0"));
		postMethod.addParameter(new NameValuePair("c0-param1", "Object_Object:{instanceId:reference:c0-e1, messageType:reference:c0-e2, messageId:reference:c0-e3, message:reference:c0-e4}"));
