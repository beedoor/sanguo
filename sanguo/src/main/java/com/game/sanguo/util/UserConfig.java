...
//		
//		digester.addSetNext("configuration/users/user/configure","setConfigure", "com.game.sanguo.domain.Configure");
//		digester.addSetNext("configuration/users/user/configure/scanResource","setScanResource", "com.game.sanguo.domain.ScanResource");
//		
//		digester.addSetNext("configuration/users/user", "addItem");
//	}
