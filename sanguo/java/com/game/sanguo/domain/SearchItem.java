...
public class SearchItem {
	...
	public String toString() {
		return "SearchItem [createDate=" + createDate + ", ext=" + ext
				+ ", frozenLevel=" + frozenLevel + ", heroPos=" + heroPos
				+ ", heroUseId=" + heroUseId + ", id=" + id + ", num=" + num
				+ ", openHeroSrcId=" + openHeroSrcId + ", sendItemFlag="
				+ sendItemFlag + ", sendItemNum=" + sendItemNum + ", sourceId="
				+ sourceId + ", storagePos=" + storagePos
				+ ", strengthenLevel=" + strengthenLevel + ", type=" + type
